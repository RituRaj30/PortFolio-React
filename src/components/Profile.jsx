...
export default function Profile() {
  ...
  return (
    <>
      ...
      <div className="px-7 flex flex-col flex-col-reverse md:flex md:flex-row md:items-center md:justify-between">
        <div className="flex flex-col gap-y-2">
          <h1 className="text-5xl md:text-4xl font-semibold text-center md:text-justify tracking-tighter">
            Hi, I am <span className="text-green-600">{configData.name}.</span>
          </h1>
        ...
        <div className="rounded-full p-2 flex items-center justify-center">
          <div className="w-[350px] h-[350px] rounded-full flex items-center justify-center ">
            <img
              src="https://praveenterax-portfolio.netlify.app/static/media/programmer.1c0ceb130210c8c3da4e6bad9c535048.svg"
              alt=""
              className=""
            />
          </div>
